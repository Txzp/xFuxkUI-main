local WindUI = {
	Window = nil,
	Theme = nil,
	Creator = require("src/modules/Creator"),
	LocalizationModule = require("src/modules/Localization"),
	NotificationModule = require("src/components/Notification"),
	Themes = nil,
	Transparent = false,
	...
	Services = require("src/utils/services/Init"),
...
local Acrylic = require("src/utils/Acrylic/Init")
